...
part 'income/income_form_helpers.dart';
part 'income/income_form_interactions.dart';
part 'income/income_form_prefill.dart';
part 'income/income_form_sections.dart';
part 'income/income_form_split_logic.dart';
part 'income/income_form_submission.dart';
...
class _IncomeFormState extends State<IncomeForm>
    with TransactionFormHelpers<IncomeForm> {
  ...
  void initState() {
    ...
    if (widget.prefilledFriend != null && widget.initialTransaction == null) {
      _sender.text = widget.prefilledFriend!.username;
    }
  }
