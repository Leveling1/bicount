...
class AnalysisScreenSkeleton extends StatelessWidget {
  const AnalysisScreenSkeleton({super.key});
...
class _AnalysisMetricSkeleton extends StatelessWidget {
  const _AnalysisMetricSkeleton();
