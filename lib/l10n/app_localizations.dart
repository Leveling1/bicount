...
abstract class AppLocalizations {
  ...
  /// No description provided for @authUnifiedTitle4.
  ///
  /// In en, this message translates to:
  /// **'worry-free'**
  String get authUnifiedTitle4;
  ...
  /// No description provided for @settingsThemeUpdatedSuccess.
  ///
  /// In en, this message translates to:
  /// **'Theme updated.'**
  String get settingsThemeUpdatedSuccess;

  /// No description provided for @settingsLanguageUpdatedSuccess.
  ///
  /// In en, this message translates to:
  /// **'Language updated.'**
  String get settingsLanguageUpdatedSuccess;

  /// No description provided for @settingsCurrencyUpdatedSuccess.
  ///
  /// In en, this message translates to:
