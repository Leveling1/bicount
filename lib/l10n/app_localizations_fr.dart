...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String get runtimeFriendUpdateFailed =>
      'Impossible de mettre à jour ce contact pour le moment.';
  ...
  String get homeWidgetBalanceFallbackSubtitle =>
      'Aucune activite recurrente n\'est prevue dans les 2 prochains jours.';
  ...
  String get profileFirstFriendHint =>
      'Créez une transaction avec quelqu\'un pour ajouter votre premier contact. Son profil pourra être lié plus tard lorsqu\'il rejoindra Bicount.';
  ...
  String get settingsFriendsDescription =>
      'Consultez vos contacts locaux et les profils déjà liés.';
  ...
  String get settingsCurrencyDescription =>
      'Choisissez la devise utilisée pour les soldes, les analyses et les totaux.';
  ...
  String get friendsDirectoryIntro =>
      'Touchez un contact pour consulter l\'historique des transactions en temps réel ou lier un profil local à un vrai compte.';
  ...
  String get friendShareProfileDescription =>
      'Générez un QR code ou un lien pour ce profil de contact précis.';
  ...
  String get friendSentEmpty =>
      'Vous n\'avez pas encore partagé de profil de contact.';
  ...
  String get friendLinkHint =>
      'Ce contact est encore local à votre compte. Utilisez le bouton de partage pour le lier lorsque la personne aura créé un profil Bicount.';
  ...
  String get friendTransactionsEmpty =>
      'Les transactions avec ce contact apparaîtront ici en temps réel.';
  ...
  String get friendEditDescription =>
      'Mettez à jour le nom local et l\'avatar utilisés pour ce contact.';
  ...
  String get transactionDebtToggleSubtitleExpense =>
      'Utilisez ceci quand vous avez avancé de l\'argent qui doit vous être remboursé plus tard.';

  @override
  String get transactionDebtToggleSubtitleIncome =>
      'Utilisez ceci quand vous avez reçu de l\'argent que vous prévoyez de rembourser plus tard.';
  ...
  String get transactionDebtDueDateRequired =>
      'Choisissez une date limite de remboursement.';

  @override
  String get transactionDebtExpectedAmountLabel =>
      'Montant attendu du remboursement (optionnel)';

  @override
  String get transactionDebtExpectedAmountHint =>
      'Laissez vide pour reprendre le montant total de la transaction';

  @override
  String get transactionDebtExpectedAmountInvalid =>
      'Saisissez un montant attendu de remboursement valide.';

  @override
  String get transactionDebtSingleBeneficiaryOnly =>
      'Le suivi de dette ne prend en charge qu\'une seule contrepartie.';

  @override
  String get transactionIncomeSenderCannotBeCurrentUser =>
      'L\'expéditeur d\'un revenu ne peut pas être vous. Pour un revenu, l\'utilisateur courant est toujours le bénéficiaire.';
  ...
  String get recurringChargesIntro =>
      'Gardez un oeil sur les charges récurrentes qui pèsent sur votre solde, ajustez-les quand le contexte change et arrêtez-les proprement quand elles ne servent plus.';

  @override
  String get recurringIncomesIntro =>
      'Regroupez ici vos revenus récurrents, mettez-les à jour quand le montant change et gardez le calendrier cohérent avec la réalité.';
  ...
  String get recurringIncomeDeleteWarning =>
      'Cette action supprimera le plan de revenu récurrent et ses paiements générés liés sur cet appareil. Continuez seulement si vous voulez vraiment retirer ce suivi.';

  @override
  String get recurringChargeDeleteWarning =>
      'Cette action supprimera le plan de charge récurrente et ses paiements générés liés sur cet appareil. Continuez seulement si vous voulez vraiment retirer ce suivi.';
  ...
  String get recurringPlanUpdatedSuccess =>
      'Plan récurrent mis à jour avec succès.';

  @override
  String get recurringPlanStoppedSuccess =>
      'Plan récurrent arrêté avec succès.';

  @override
  String get recurringPlanDeletedSuccess =>
      'Plan récurrent supprimé avec succès.';

  @override
  String get runtimeRecurringPlanUpdateFailed =>
      'Impossible de mettre à jour ce plan récurrent pour le moment.';

  @override
  String get runtimeRecurringPlanTerminateFailed =>
      'Impossible d\'arrêter ce plan récurrent pour le moment.';

  @override
  String get runtimeRecurringPlanDeleteFailed =>
      'Impossible de supprimer ce plan récurrent pour le moment.';

  @override
  String get runtimeRecurringSalaryConfirmFailed =>
      'Impossible de confirmer ce salaire récurrent pour le moment.';

  @override
  String get runtimeRecurringSalaryUpdateFailed =>
      'Impossible de mettre à jour ce salaire récurrent pour le moment.';
  ...
  String get recurringToggleSubtitleExpense =>
      'Ce montant sera débité de votre solde de manière récurrente.';

  @override
  String get recurringToggleSubtitleIncome =>
      'Ce montant sera crédité sur votre solde de manière récurrente.';
  ...
  String get debtEmptyState =>
      'Aucune dette active ne demande votre attention pour le moment.';
  ...
  String get debtPermissionHint =>
      'Seule la partie autorisée peut enregistrer les remboursements reçus pour cette dette.';

  @override
  String get debtInvalidPaymentAmount =>
      'Saisissez un montant valide qui ne dépasse pas le reste à payer.';

  @override
  String get debtPaymentRecordedSuccess =>
      'Paiement de dette enregistré avec succès.';
  ...
  String get debtRepaymentAmountTooHigh =>
      'Le montant remboursé ne peut pas dépasser le reste à payer.';

  @override
  String get debtRepaymentManageFromDebtScreen =>
      'Les remboursements de dette ne peuvent être gérés que depuis l\'écran des dettes.';

  @override
  String get debtOnlyLenderCanRecord =>
      'Seul le prêteur peut confirmer un remboursement reçu.';

  @override
  String get debtOnlyCreatorCanUpdate =>
      'Seul le créateur peut mettre cette dette à jour pour le moment.';

  @override
  String get debtOnlyCreatorCanDelete =>
      'Seul le créateur peut supprimer cette dette pour le moment.';

  @override
  String get debtExpectedAmountTooLow =>
      'Le montant attendu ne peut pas être inférieur à la somme déjà remboursée.';
  ...
  String get debtDeleteConfirmDescription =>
      'Cette action supprime le contrat de dette, la transaction initiale liée et tous les remboursements déjà enregistrés pour cette dette.';
